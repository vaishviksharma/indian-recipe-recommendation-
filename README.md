...
-> install all the dependiencies as :
   # $ pip install -r requirements.txt

-> if above step shows some error while downloading one or the other packages then go for installing packages manually one by one by :
  # e.g : pip install ________(flask)

-> Run the application.py file as :
  # python application.py 

-> Lastly open the hostlink that will pop up once compiler fineshes the execution 
  # by CTRL+ Click on it